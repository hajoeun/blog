...
### 보조 함수의 활용
##### 1. 고차 함수란?
고차 함수는 __값으로 다룰 수 있는 함수__다. 함수를 값으로 다룰 수 있기 때문에 __함수를 인자로 사용__할 수도 있고 함수를 __리턴값으로 사용__할 수도 있다. 이러한 특징을 잘 보여주는 예제가 [지난 시간](/functional-js-study/) 살펴본 함수들이 가진 보조함수들이다. `each`를 다시 한번 살펴보자.
...
[예제 코드](https://github.com/hajoeun/functional-js-study/tree/master/02_week)
