---
title: 함수와 주석 그리고 오류 처리
description: '클린 코드: 협업을 위한 코드 3'
...
![](/images/clean-code/code-review-4.png)
...
const renderSubFigure = (subFigure) => optional(subFigure, (it) => <figure>{it}</figure>);
```
